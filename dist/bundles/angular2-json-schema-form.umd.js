(function (global, factory) {
	...
	(factory((global.angular2JsonSchemaForm = {}),global.ng.core,global.lodash,global.ng.forms,global.Ajv,global.ng.platformBrowser,global.ng.common,global.ng.flexLayout,global.ng.material));
}(this, (function (exports,core,lodash,forms,Ajv,platformBrowser,common,flexLayout,material) { 'use strict';
...
var JsonSchemaFormComponent = (function () {
    ...
    JsonSchemaFormComponent.prototype.ngOnChanges = function (changes) {
        if (!lodash.isEqual(changes.data.currentValue, changes.data.previousValue)) {
            this.updateForm();
        }
    };
...
var MaterialDesignFrameworkComponent = (function () {
    ...
    MaterialDesignFrameworkComponent.prototype.initializeFramework = function () {
        if (this.layoutNode) {
            ...
            this.widgetLayoutNode = __assign$7({}, this.layoutNode, { options: lodash.cloneDeep(this.layoutNode.options || {}) });
