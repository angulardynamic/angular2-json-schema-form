(function (global, factory) {
    ...
    (factory((global.angular2JsonSchemaForm = {}),global.rxjs,global.ng.core,global.lodash,global.ng.forms,global.Ajv,global.ng.platformBrowser,global.ng.common,global.ng.flexLayout,global.ng.material));
}(this, (function (exports,rxjs,core,lodash,forms,Ajv,platformBrowser,common,flexLayout,material) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var JsonValidators = (function () {
        ...
        JsonValidators.min = function (min$$1) {
            if (!hasValue(min$$1)) {
                return JsonValidators.nullValidator;
            }
            return function (control) {
                if (isEmpty(control.value) || isEmpty(min$$1)) {
                    return null;
                }
                var value = parseFloat(control.value);
                var actual = control.value;
                return isNaN(value) || value >= min$$1 ? null : { 'min': { min: min$$1, actual: actual } };
            };
        };
        JsonValidators.max = function (max$$1) {
            if (!hasValue(max$$1)) {
                return JsonValidators.nullValidator;
            }
            return function (control) {
                if (isEmpty(control.value) || isEmpty(max$$1)) {
                    return null;
                }
                var value = parseFloat(control.value);
                var actual = control.value;
                return isNaN(value) || value <= max$$1 ? null : { 'max': { max: max$$1, actual: actual } };
            };
        };
    ...
    var JsonSchemaFormComponent = (function () {
        ...
        JsonSchemaFormComponent.prototype.ngOnChanges = function (changes) {
            ...
            Object.keys(changes).forEach(function (key) {
                ...
                if (!lodash.isEqual(change.currentValue, change.previousValue)) {
                    update = true;
                }
            });
            if (update) {
    ...
    var FrameworkEditorLibraryService = (function () {
        ...
        FrameworkEditorLibraryService.ctorParameters = function () { return [
            { type: Array, decorators: [{ type: core.Inject, args: [Framework,] },] },
            { type: WidgetEditorLibraryService, decorators: [{ type: core.Inject, args: [WidgetEditorLibraryService,] },] },
        ]; };
    ...
    var SharedModule = (function () {
        ...
        SharedModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, forms.FormsModule, forms.ReactiveFormsModule, DndModule.forRoot()],
    ...
    var WidgetLibraryModule = (function () {
        ...
        WidgetLibraryModule.decorators = [
            { type: core.NgModule, args: [{
                        imports: [common.CommonModule, forms.FormsModule, forms.ReactiveFormsModule, SharedModule],
    ...
    var MaterialDesignFrameworkComponent = (function () {
        ...
        MaterialDesignFrameworkComponent.prototype.initializeFramework = function () {
            if (this.layoutNode) {
                ...
                this.widgetLayoutNode = __assign$8({}, this.layoutNode, { options: lodash.cloneDeep(this.layoutNode.options || {}) });
    ...
    var Bootstrap3FrameworkComponent = (function () {
        ...
        Bootstrap3FrameworkComponent.prototype.initializeFramework = function () {
            ...
            if (this.layoutNode) {
                this.options = lodash.cloneDeep(this.layoutNode.options);
                this.widgetLayoutNode = __assign$9({}, this.layoutNode, { options: lodash.cloneDeep(this.layoutNode.options) });
                this.widgetOptions = this.widgetLayoutNode.options;
                this.formControl = this.jsf.getFormControl(this);
    ...
    var Bootstrap4FrameworkComponent = (function () {
        ...
        Bootstrap4FrameworkComponent.prototype.initializeFramework = function () {
            ...
            if (this.layoutNode) {
                this.options = lodash.cloneDeep(this.layoutNode.options);
                this.widgetLayoutNode = __assign$a({}, this.layoutNode, { options: lodash.cloneDeep(this.layoutNode.options) });
                this.widgetOptions = this.widgetLayoutNode.options;
                this.formControl = this.jsf.getFormControl(this);
                this.options.isInputWidget = inArray(this.layoutNode.type, [
                    'button', 'checkbox', 'checkboxes-inline', 'checkboxes', 'color',
    ...
    exports.ɵe = BASIC_WIDGETS$1;
    exports.ɵd = BASIC_WIDGETS;
    ...
    exports.JsonSchemaFormEditorComponent = JsonSchemaFormEditorComponent;
    exports.JsonSchemaFormService = JsonSchemaFormService;
    exports.JsonSchemaFormModule = JsonSchemaFormModule;
    exports.JsonSchemaFormEditorModule = JsonSchemaFormEditorModule;
    exports.WidgetLibraryService = WidgetLibraryService;
    exports.WidgetEditorLibraryService = WidgetEditorLibraryService;
    exports.WidgetLibraryModule = WidgetLibraryModule;
    exports.WidgetEditorLibraryModule = WidgetEditorLibraryModule;
    ...
    exports.AddReferenceEditorComponent = AddReferenceEditorComponent;
    exports.OneOfEditorComponent = OneOfEditorComponent;
    exports.ButtonEditorComponent = ButtonEditorComponent;
    exports.CheckboxEditorComponent = CheckboxEditorComponent;
    exports.CheckboxesEditorComponent = CheckboxesEditorComponent;
    exports.FileEditorComponent = FileEditorComponent;
    exports.HiddenEditorComponent = HiddenEditorComponent;
    exports.InputEditorComponent = InputEditorComponent;
    exports.MessageEditorComponent = MessageEditorComponent;
    exports.NoneEditorComponent = NoneEditorComponent;
    exports.NumberEditorComponent = NumberEditorComponent;
    exports.RadiosEditorComponent = RadiosEditorComponent;
    exports.RootEditorComponent = RootEditorComponent;
    exports.SectionEditorComponent = SectionEditorComponent;
    exports.SelectEditorComponent = SelectEditorComponent;
    exports.SelectFrameworkEditorComponent = SelectFrameworkEditorComponent;
    exports.SelectWidgetEditorComponent = SelectWidgetEditorComponent;
    exports.SubmitEditorComponent = SubmitEditorComponent;
    exports.TabEditorComponent = TabEditorComponent;
    exports.TabsEditorComponent = TabsEditorComponent;
    exports.TemplateEditorComponent = TemplateEditorComponent;
    exports.TextareaEditorComponent = TextareaEditorComponent;
    exports.FrameworkLibraryService = FrameworkLibraryService;
    exports.FrameworkEditorLibraryService = FrameworkEditorLibraryService;
